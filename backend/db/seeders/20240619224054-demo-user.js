...
module.exports = {
  ...
  async down (queryInterface, Sequelize) {
    ...
    return queryInterface.bulkDelete(options, {
      username: { 
        [Op.in]: [
          'RingBearer', 'SamTheMan', 'Strider', 'ElvenPrince', 
          'DwarfWarrior', 'Wizard', 'CaptainOfGondor', 
          'LadyGaladriel', 'Elrond', 'Shieldmaiden', 'Bilbo', 
          'Merry', 'Pippin', 'Glorfindel', 'Elrohir', 'Elladan', 
          'Thorin', 'Dwalin', 'Balin', 'Fili', 'Celeborn', 'Haldir', 
          'Thranduil'
        ] 
      }
    }, {});
